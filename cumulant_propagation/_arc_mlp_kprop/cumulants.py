...
from cumulant_propagation._arc_mlp_kprop.partitions import set_partitions
from cumulant_propagation._arc_mlp_kprop.tensor_utils import *
from cumulant_propagation._arc_mlp_kprop.logging_utils import *

logger = logging.getLogger(__name__)

Samples: TypeAlias = Float[Tensor, "samples n"]  # Note this is the transpose of the torch.cov convention
SampleStream: TypeAlias = Iterator[Samples]  # samples -> (samples n)
