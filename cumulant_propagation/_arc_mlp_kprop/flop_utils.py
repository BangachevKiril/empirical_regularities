...
from cumulant_propagation._arc_mlp_kprop.partitions import IntPartition
...
def _fit_flop_polys(mlp_kwargs, kprop_kwargs):
    ...
    from cumulant_propagation._arc_mlp_kprop.kprop_harmonic import mlp_kprop as _mlp_kprop
