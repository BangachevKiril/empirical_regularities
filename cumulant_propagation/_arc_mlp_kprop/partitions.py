...
IntPartition: TypeAlias = tuple[int, ...]
SetPartition: TypeAlias = tuple[frozenset[T], ...]
Vec: TypeAlias = tuple[int, ...]
VecPartition: TypeAlias = tuple[Vec, ...]
...
class IntPartCond:
    ...
    def __and__(
        self, other: Self | Callable[[IntPartition], bool] | Iterator[IntPartition]
    ) -> Self:
